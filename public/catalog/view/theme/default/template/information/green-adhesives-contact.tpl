...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="htabs" id="tabs">
    ...
    <a class="selected" href="index.php?route=information/green-adhesives-contact" style="display: inline;">Contact Adhesive</a>
  </div>
  <div id="tab-contact" class="tab-content"><?php echo $contact; ?></div>
