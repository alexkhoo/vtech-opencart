...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="htabs" id="tabs">
    ...
    <a class="selected" href="index.php?route=information/green-adhesives-construction" style="display: inline;">Construction Adhesive</a>
  ...
  <div id="tab-construction" class="tab-content"><?php echo $construction; ?></div>
